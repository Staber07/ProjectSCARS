...
def create_tenant(display_name, allow_password_sign_up=..., enable_email_link_sign_in=..., app=...):
...
def update_tenant(tenant_id, display_name=..., allow_password_sign_up=..., enable_email_link_sign_in=..., app=...):
...
class _TenantManagementService:
    ...
    def auth_for_tenant(self, tenant_id): # -> Client:
        """Gets an Auth Client instance scoped to the given tenant ID."""
        ...
    ...
    def create_tenant(self, display_name, allow_password_sign_up=..., enable_email_link_sign_in=...): # -> Tenant:
        """Creates a new tenant from the given parameters."""
        ...
    
    def update_tenant(self, tenant_id, display_name=..., allow_password_sign_up=..., enable_email_link_sign_in=...): # -> Tenant:
