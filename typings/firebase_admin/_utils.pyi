...
def handle_platform_error_from_requests(error, handle_func=...): # -> DeadlineExceededError | UnavailableError | UnknownError:
...
def handle_operation_error(error): # -> UnknownError:
...
def handle_requests_error(error, message=..., code=...): # -> DeadlineExceededError | UnavailableError | UnknownError:
    """Constructs a ``FirebaseError`` from the given requests error.
