...
def list_models(list_filter=..., page_size=..., page_token=..., app=...): # -> ListModelsPage:
...
class Model:
    ...
    @display_name.setter
    def display_name(self, display_name): # -> Self:
        ...
    ...
    @model_format.setter
    def model_format(self, model_format): # -> Self:
        ...
    
    def as_dict(self, for_upload=...): # -> dict[Any, Any]:
...
class TFLiteFormat(ModelFormat):
    ...
    def as_dict(self, for_upload=...): # -> dict[str, dict[Any, Any]]:
        """Returns a serializable representation of the object."""
        ...
...
class _CloudStorageClient:
    ...
    @staticmethod
    def sign_uri(gcs_tflite_uri, app): # -> str:
...
class TFLiteGCSModelSource(TFLiteModelSource):
    ...
    @classmethod
    def from_tflite_model_file(cls, model_file_name, bucket_name=..., app=...): # -> TFLiteGCSModelSource:
    ...
    @classmethod
    def from_saved_model(cls, saved_model_dir, model_file_name=..., bucket_name=..., app=...): # -> TFLiteGCSModelSource:
    ...
    @classmethod
    def from_keras_model(cls, keras_model, model_file_name=..., bucket_name=..., app=...): # -> TFLiteGCSModelSource:
    ...
    def as_dict(self, for_upload=...): # -> dict[str, str] | dict[str, Any]:
        """Returns a serializable representation of the object."""
        ...
...
class TFLiteAutoMlSource(TFLiteModelSource):
    ...
    def as_dict(self, for_upload=...): # -> dict[str, Any]:
        """Returns a serializable representation of the object."""
        ...
...
class _MLService:
    ...
    def handle_operation(self, operation, wait_for_operation=..., max_time_seconds=...): # -> dict[Any, Any] | None:
    ...
    def create_model(self, model): # -> dict[Any, Any] | None:
        ...
    
    def update_model(self, model, update_mask=...): # -> dict[Any, Any] | None:
        ...
    
    def set_published(self, model_id, publish): # -> dict[Any, Any] | None:
        ...
