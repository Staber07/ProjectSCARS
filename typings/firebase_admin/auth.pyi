...
from firebase_admin import _auth_client, _auth_providers, _auth_utils, _token_gen, _user_identifier, _user_import, _user_mgt
...
def create_custom_token(uid, developer_claims=..., app=...):
...
def verify_id_token(id_token, app=..., check_revoked=..., clock_skew_seconds=...):
...
def create_session_cookie(id_token, expires_in, app=...):
...
def verify_session_cookie(session_cookie, check_revoked=..., app=..., clock_skew_seconds=...):
...
def get_user_by_email(email, app=...):
...
def get_user_by_phone_number(phone_number, app=...):
...
def list_users(page_token=..., max_results=..., app=...):
...
def import_users(users, hash_alg=..., app=...):
...
def generate_password_reset_link(email, action_code_settings=..., app=...):
...
def generate_email_verification_link(email, action_code_settings=..., app=...):
...
def generate_sign_in_with_email_link(email, action_code_settings, app=...):
...
def get_oidc_provider_config(provider_id, app=...):
...
def create_oidc_provider_config(provider_id, client_id, issuer, display_name=..., enabled=..., client_secret=..., id_token_response_type=..., code_response_type=..., app=...):
...
def update_oidc_provider_config(provider_id, client_id=..., issuer=..., display_name=..., enabled=..., client_secret=..., id_token_response_type=..., code_response_type=..., app=...):
...
def list_oidc_provider_configs(page_token=..., max_results=..., app=...):
...
def get_saml_provider_config(provider_id, app=...):
...
def create_saml_provider_config(provider_id, idp_entity_id, sso_url, x509_certificates, rp_entity_id, callback_url, display_name=..., enabled=..., app=...):
...
def update_saml_provider_config(provider_id, idp_entity_id=..., sso_url=..., x509_certificates=..., rp_entity_id=..., callback_url=..., display_name=..., enabled=..., app=...):
...
def list_saml_provider_configs(page_token=..., max_results=..., app=...):
