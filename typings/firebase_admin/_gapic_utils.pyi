...
def handle_platform_error_from_googleapiclient(error, handle_func=...): # -> DeadlineExceededError | UnavailableError | UnknownError:
...
def handle_googleapiclient_error(error, message=..., code=..., http_response=...): # -> DeadlineExceededError | UnavailableError | UnknownError:
    """Constructs a ``FirebaseError`` from the given googleapiclient error.
