...
class HttpClient:
    ...
    necessary.
    """
    def __init__(self, credential=..., session=..., base_url=..., headers=..., retries=..., timeout=...) -> None:
    ...
    def headers(self, method, url, **kwargs): # -> CaseInsensitiveDict[str]:
        ...
    
    def body_and_response(self, method, url, **kwargs): # -> tuple[Any, Response | Any]:
        ...
    
    def body(self, method, url, **kwargs):
        ...
    
    def headers_and_body(self, method, url, **kwargs): # -> tuple[CaseInsensitiveDict[str] | Any, Any]:
        ...
