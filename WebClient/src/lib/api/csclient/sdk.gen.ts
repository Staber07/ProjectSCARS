 ...
 */
export const uploadAttachmentEndpointV1ReportsReportsAttachmentsUploadPost = <ThrowOnError extends boolean = false>(options: Options<UploadAttachmentEndpointV1ReportsReportsAttachmentsUploadPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UploadAttachmentEndpointV1ReportsReportsAttachmentsUploadPostResponses, UploadAttachmentEndpointV1ReportsReportsAttachmentsUploadPostErrors, ThrowOnError>({
        ...formDataBodySerializer,
        security: [
            {
                scheme: 'bearer',
 ...
 * Success message.
 */
export const deleteAttachmentEndpointV1ReportsReportsAttachmentsFileUrnDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteAttachmentEndpointV1ReportsReportsAttachmentsFileUrnDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteAttachmentEndpointV1ReportsReportsAttachmentsFileUrnDeleteResponses, DeleteAttachmentEndpointV1ReportsReportsAttachmentsFileUrnDeleteErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getAttachmentEndpointV1ReportsReportsAttachmentsFileUrnGet = <ThrowOnError extends boolean = false>(options: Options<GetAttachmentEndpointV1ReportsReportsAttachmentsFileUrnGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAttachmentEndpointV1ReportsReportsAttachmentsFileUrnGetResponses, GetAttachmentEndpointV1ReportsReportsAttachmentsFileUrnGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getAttachmentsMetadataEndpointV1ReportsReportsAttachmentsMetadataPost = <ThrowOnError extends boolean = false>(options: Options<GetAttachmentsMetadataEndpointV1ReportsReportsAttachmentsMetadataPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetAttachmentsMetadataEndpointV1ReportsReportsAttachmentsMetadataPostResponses, GetAttachmentsMetadataEndpointV1ReportsReportsAttachmentsMetadataPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
