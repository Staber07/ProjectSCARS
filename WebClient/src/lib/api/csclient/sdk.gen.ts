...
/**
 * Get School Daily Financial Report
 ...
 */
export const getSchoolDailyFinancialReportV1ReportsDailySchoolIdYearMonthGet = <ThrowOnError extends boolean = false>(options: Options<GetSchoolDailyFinancialReportV1ReportsDailySchoolIdYearMonthGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetSchoolDailyFinancialReportV1ReportsDailySchoolIdYearMonthGetResponses, GetSchoolDailyFinancialReportV1ReportsDailySchoolIdYearMonthGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Update School Daily Report Entries
 ...
 */
export const updateSchoolDailyReportEntriesV1ReportsDailySchoolIdYearMonthEntryPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateSchoolDailyReportEntriesV1ReportsDailySchoolIdYearMonthEntryPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateSchoolDailyReportEntriesV1ReportsDailySchoolIdYearMonthEntryPatchResponses, UpdateSchoolDailyReportEntriesV1ReportsDailySchoolIdYearMonthEntryPatchErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Add Daily Financial Report Entry
 * Add an entry to a daily financial report for a school for a specific month.
 */
export const addDailyFinancialReportEntryV1ReportsDailySchoolIdYearMonthAddPut = <ThrowOnError extends boolean = false>(options: Options<AddDailyFinancialReportEntryV1ReportsDailySchoolIdYearMonthAddPutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AddDailyFinancialReportEntryV1ReportsDailySchoolIdYearMonthAddPutResponses, AddDailyFinancialReportEntryV1ReportsDailySchoolIdYearMonthAddPutErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
