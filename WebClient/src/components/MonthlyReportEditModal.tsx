...
export function MonthlyReportEditModal({ opened, onClose, report, onUpdate }: MonthlyReportEditModalProps) {
    ...
    return (
        <Modal
            opened={opened}
            onClose={onClose}
            title="Edit Monthly Report - Noted By"
            size="md"
        >
            <form onSubmit={form.onSubmit(handleSubmit)}>
                <Stack gap="md">
                    ...
                    <Stack gap="xs" mt="md">
                        <Text size="sm" fw={500}>Report Details</Text>
                        ...
                        <Group justify="space-between">
                            ...
                            <Text size="sm" tt="capitalize">{report.reportStatus || "Draft"}</Text>
                        </Group>

                        <Group justify="space-between">
                            <Text size="sm" c="dimmed">Prepared By:</Text>
                            <Text size="sm">{report.preparedBy || "N/A"}</Text>
                        </Group>

                        {report.dateApproved && (
                            <Group justify="space-between">
                                <Text size="sm" c="dimmed">Date Approved:</Text>
                                <Text size="sm">
                        ...
                        {(report.reportStatus === "received" || report.reportStatus === "archived") && report.dateReceived && (
                            <Group justify="space-between">
                                <Text size="sm" c="dimmed">Date Received:</Text>
                                <Text size="sm">
